...
namespace Hotel.Web.Areas.Restaurant.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DishID,DishName,Quantity,Instruction,DishPrice,CategoryId")] Menu menu)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isDuplicateFound)
                {
                    ModelState.AddModelError("DishName", "Duplicate! Same Dish exists");
                }
                else
                {
                    _context.Add(menu);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DishID,DishName,Quantity,Instruction,DishPrice,CategoryId")] Menu menu)
        {
            if (id != menu.DishID)
            {
                return NotFound();
